...
--------------------------------------------------
MSG = [#reference] <type*>.<subtype>(<scope*>): <subject*>
--------------------------------------------------
...
1) Indicate a reference (not mandatory). You can leave this value blank.

----
[#reference] <<< 123|
----

2) You will have to choose a **type** (mandatory) and a **subtype** (not mandatory).
...
For example (with do => docs()):

----
[#123] <type*>.<subtype> <<< do|
----

3) You will have to **choose the scope**.
...
----
[#123] docs(<scope*>) <<< [README.adoc] |
----

4) Then, indicate the **subject**:

----
[#123] docs(README.adoc): <subject*> <<< update licence section|
----
...
----
--------------------------------------------------
[#123] docs(README.adoc): update licence section
--------------------------------------------------
