...
== Roadmap & Public Alpha Version

**{MAIN_TITLE}** has recently been released (June 2018) in **public alpha version**.
This means that this version is being tested and stabilized with some people (Thank you!).

Comments, suggestions? Feel free to make them to me in the https://github.com/jprivet-dev/git-xtended/issues[Git issues section of that project] :)
