...
image::doc/img/gbw-screenshot-prompt.png[{PROMPT_PS1}]
...
image::doc/img/gbw-screenshot-prompt-no-change.png[{PROMPT_PS1_NO_CHANGE}]

In *one change case*, you can see :

image::doc/img/gbw-screenshot-prompt-one-change.png[{PROMPT_PS1_ONE_CHANGE}]
