...
[cols=".^1,.^2"]
|===
h| Codacy | image:https://app.codacy.com/project/badge/Grade/31960ec18f3d4134b92e9164255dee6e["Codacy code quality", link="https://www.codacy.com/gh/jprivet-dev/git-xtended/dashboard?utm_source=github.com&utm_medium=referral&utm_content=jprivet-dev/git-xtended&utm_campaign=Badge_Grade"]
h| Last release | https://github.com/jprivet-dev/git-xtended/releases/tag/{LAST_RELEASE}[{LAST_RELEASE}]
h| Documentation | https://www.jprivet.dev/git-xtended
|===
...
NOTE: More information on https://www.jprivet.dev/git-xtended/#show-git-aliases[Git Xtended Documentation - GX Help - Show Git aliases]
...
NOTE: More information on https://www.jprivet.dev/git-xtended/#show-gx-commands[Git Xtended Documentation - GX Help - Show GX commands]
