...
_GX_HOOKS_PCMSG_TYPE_LABEL="${C_LIGHT_MAGENTA}<type*>${F_RESET}"
_GX_HOOKS_PCMSG_SUBTYPE_LABEL="${C_LIGHT_RED}<subtype>${F_RESET}"
_GX_HOOKS_PCMSG_MAINSCOPE_LABEL="${C_LIGHT_GREEN}<scope*>${F_RESET}"
_GX_HOOKS_PCMSG_SUBJECT_LABEL="${C_LIGHT_YELLOW}<subject*>${F_RESET}"
