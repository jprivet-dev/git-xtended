...
_GX_HOOKS_PCMSG_TYPE_COLOR="${C_LIGHT_BLUE}"
_GX_HOOKS_PCMSG_SCOPE_COLOR="${C_LIGHT_YELLOW}"
_GX_HOOKS_PCMSG_SUBJECT_COLOR="${C_CYAN}"
_GX_HOOKS_PCMSG_REFERENCE_COLOR="${C_LIGHT_RED}"

_GX_HOOKS_PCMSG_TYPE_SHORTCUT_COLOR="${F_UNDERLINED}${_GX_HOOKS_PCMSG_TYPE_COLOR}"
