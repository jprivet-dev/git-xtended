...
function gx_git_config_aliases_help {
    ...
    gx_git_config_aliases_help_line "checkout |" "${GX_PARAMS_GIT_ALIAS_CK}"  "[1 2 ... n]" .... "Extended \"checkout\" alias ${select_file}"
    ...
    gx_git_config_aliases_help_line "    diff |" "${GX_PARAMS_GIT_ALIAS_D}"  "[1 2 ... n]" ..... "Extended \"diff\" alias ${select_file}"
    gx_git_config_aliases_help_line "     add |" "${GX_PARAMS_GIT_ALIAS_A}"  "[1 2 ... n]" ..... "Extended \"add\" alias ${select_file}"
    ...
    gx_git_config_aliases_help_line "  commit |" "${GX_PARAMS_GIT_ALIAS_C}"  "[1 2 ... n]" ..... "Extended \"commit\" alias ${select_file}"
