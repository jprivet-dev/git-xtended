...
function gx_git_config_aliases_help() {
    ...
    gx_git_config_aliases_help_line "          " "${GX_PARAMS_GIT_ALIAS_RESTORE}" "[<i>|<path>]" ........ "${F_UNDERLINED}Indexed${F_RESET} \"checkout\" command for restoring files from the working tree ${select_file}"
