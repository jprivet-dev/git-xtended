...
function gx_git_config_aliases_help() {
    ...
    gx_git_config_aliases_help_line "checkout |" "${GX_PARAMS_GIT_ALIAS_CANCEL}" "[<i>|<path>]" .. "Extended \"checkout\" command ${select_file}"
    ...
    gx_git_config_aliases_help_line "    diff |" "${GX_PARAMS_GIT_ALIAS_D}" "[<i>|<path>]" ....... "Extended \"diff\" command ${select_file}"
    gx_git_config_aliases_help_line "     add |" "${GX_PARAMS_GIT_ALIAS_A}" "[<i>|<path>]" ....... "Extended \"add\" command ${select_file}"
    ...
    gx_git_config_aliases_help_line "  commit |" "${GX_PARAMS_GIT_ALIAS_C}" "[<i>|<path>|all]" ... "Extended \"commit\" command ${select_file}"
    ...
    gx_git_config_aliases_help_line "  others |" "${GX_PARAMS_GIT_ALIAS_PR}" "" ................... "Generates the url to compare and create a PR with the current branch"
    echo
}
