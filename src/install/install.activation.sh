...
function gbw_install_activation {
    ...
    [ "$GBW_PARAMS_INSTALL_GIT_ALIASES_ACTIVE" == "$GBW_PARAMS_ACTIVE" ]    && gbw_git_aliases_on           || gbw_git_aliases_disable
    [ "$GBW_PARAMS_INSTALL_GIT_HOOKS_ACTIVE" == "$GBW_PARAMS_ACTIVE" ]      && gbw_git_config_hooks_on      || gbw_git_config_hooks_disable
    [ "$GBW_PARAMS_INSTALL_WORKFLOW_ACTIVE" == "$GBW_PARAMS_ACTIVE" ]       && gbw_git_config_workflow_on   || gbw_git_config_workflow_disable
    [ "$GBW_PARAMS_INSTALL_BASH_ALIASES_ACTIVE" == "$GBW_PARAMS_ACTIVE" ]   && gbw_bash_aliases_on          || gbw_bash_aliases_disable
}
