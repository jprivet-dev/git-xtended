...
function gbw_install_choice_params_set_all_from_git_config {
    GBW_PARAMS_INSTALL_PROMPT_ACTIVE="`gwb_git_config_get ${GBW_PARAMS_GIT_CONFIG_KEY_PROMPT} ${GBW_PARAMS_DISABLED}`"
    GBW_PARAMS_INSTALL_GIT_ALIASES_ACTIVE="`gwb_git_config_get ${GBW_PARAMS_GIT_CONFIG_KEY_GIT_ALIASES} ${GBW_PARAMS_DISABLED}`"
    GBW_PARAMS_INSTALL_GIT_HOOKS_ACTIVE="`gwb_git_config_get ${GBW_PARAMS_GIT_CONFIG_KEY_GIT_HOOKS} ${GBW_PARAMS_DISABLED}`"
    GBW_PARAMS_INSTALL_WORKFLOW_ACTIVE="`gwb_git_config_get ${GBW_PARAMS_GIT_CONFIG_KEY_WORKFLOW} ${GBW_PARAMS_DISABLED}`"
    GBW_PARAMS_INSTALL_BASH_ALIASES_ACTIVE="`gwb_git_config_get ${GBW_PARAMS_GIT_CONFIG_KEY_BASH_ALIASES} ${GBW_PARAMS_DISABLED}`"
}