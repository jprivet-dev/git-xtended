...
GBW_INSTALL_CHOICE_Y_N_LAST_VALUE=""
...
function gbw_install_choice_y_n {
    ...
    if [ "$choice" == "y" ]; then
        GBW_INSTALL_CHOICE_Y_N_LAST_VALUE=1
        return
    fi

    GBW_INSTALL_CHOICE_Y_N_LAST_VALUE=0
    return
}

gbw_install_choice_y_n "Activate 'Prompt with Git information'"
GBW_PARAMS_INSTALL_PROMPT_ACTIVE="$GBW_INSTALL_CHOICE_Y_N_LAST_VALUE"

gbw_install_choice_y_n "Activate 'Git aliases'"
GBW_PARAMS_INSTALL_GIT_ALIASES_ACTIVE="$GBW_INSTALL_CHOICE_Y_N_LAST_VALUE"

gbw_install_choice_y_n "Activate 'Git hooks (Agility)'"
GBW_PARAMS_INSTALL_GIT_HOOKS_ACTIVE="$GBW_INSTALL_CHOICE_Y_N_LAST_VALUE"

gbw_install_choice_y_n "Activate 'Git workflow commands (Agility)'"
GBW_PARAMS_INSTALL_GIT_WORKFLOW_ACTIVE="$GBW_INSTALL_CHOICE_Y_N_LAST_VALUE"

gbw_install_choice_y_n "Activate 'Bash aliases'"
GBW_PARAMS_INSTALL_BASH_ALIASES_ACTIVE="$GBW_INSTALL_CHOICE_Y_N_LAST_VALUE"
