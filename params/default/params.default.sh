...
GX_PARAMS_LABEL_PROMPT="Prompt with Git information"
GX_PARAMS_LABEL_REMOTE_REF_BRANCH="Remote reference branch"
GX_PARAMS_LABEL_GIT_ALIASES="Git aliases"
GX_PARAMS_LABEL_GX_COMMANDS="${GX_PARAMS_TITLE_SHORT} commands"
