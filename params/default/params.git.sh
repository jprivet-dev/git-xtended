...
GX_PARAMS_GIT_CONFIG_KEY_PROMPT="${GX_PARAMS_GIT_CONFIG_KEY_ROOT}.prompt"
GX_PARAMS_GIT_CONFIG_KEY_GIT_ALIASES="${GX_PARAMS_GIT_CONFIG_KEY_ROOT}.gitaliases"
...
GX_PARAMS_GIT_CONFIG_KEY_PROMPT_STATUS="${GX_PARAMS_GIT_CONFIG_KEY_PROMPT}.status"
GX_PARAMS_GIT_CONFIG_KEY_GIT_ALIASES_STATUS="${GX_PARAMS_GIT_CONFIG_KEY_GIT_ALIASES}.status"
