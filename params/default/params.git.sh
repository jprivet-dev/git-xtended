...
GX_PARAMS_GIT_ALIAS_RELEASE_FILE="${GX_PARAMS_ROOT}/src/git/alias/git.alias.release.sh"
...
GX_PARAMS_GIT_ALIAS_ONEDAY="oneday"
...
GX_PARAMS_GIT_ALIAS_RELEASE="release"
