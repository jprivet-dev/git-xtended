...
GX_PARAMS_GIT_CONFIG_KEY_GIT_COMMIT_LAST_MAINSCOPE="${GX_PARAMS_GIT_CONFIG_KEY_ROOT}.commit-last-main"
...
GX_PARAMS_GIT_CONFIG_KEY_GIT_COMMIT_LAST_SUBTYPE_INDEX="${GX_PARAMS_GIT_CONFIG_KEY_ROOT}.commit-last-subtype"
