...
GBW_PARAMS_GIT_CONFIG_KEY_PROMPT_ACTIVE="gbw.prompt"
GBW_PARAMS_GIT_CONFIG_KEY_ALIASES_ACTIVE="gbw.aliases"
GBW_PARAMS_GIT_CONFIG_KEY_HOOKS_ACTIVE="gbw.aliases"
